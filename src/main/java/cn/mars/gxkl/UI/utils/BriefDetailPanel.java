...
public class BriefDetailPanel extends JPanel implements MouseListener,ActionListener,PannelExecutor<BriefDetailObject>{
	...
	public BriefDetailPanel (int width,int height,String str){
		this.width=width;
		this.height=height;
		this.str=str;
	...
	private void initialization(){
		...
		ValueTextField.setPreferredSize(new Dimension((int)(width*0.2),(int)(height*0.7)));
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(e.getSource()==this){
			...
			int n = JOptionPane.showConfirmDialog(null, "确认更改参数吗", "确认更改", JOptionPane.YES_NO_OPTION); 
